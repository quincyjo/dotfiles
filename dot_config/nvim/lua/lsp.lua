...
local function on_attach(client, bufnr)
	...
	keymap("<leader>aa", vim.diagnostic.setqflist, "All workspace diagnostics")
	...
	keymap("<leader>d", vim.diagnostic.setloclist, "Buffer diagnostics")
		...
		virtual_text = {
			...
			format = function(diagnostic)
				...
				if diagnostic.code then
					...
					local first_line = line_index and (diagnostic.message:sub(1, line_index - 1) .. misc_icons.ellipsis)
